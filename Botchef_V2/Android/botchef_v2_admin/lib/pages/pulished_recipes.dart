...
class PublishedRecipes extends StatefulWidget {
  const PublishedRecipes({super.key});

  @override
  State<PublishedRecipes> createState() => _PublishedRecipesState();
}

class _PublishedRecipesState extends State<PublishedRecipes> {
          ...
          itemBuilder: (context, documentSnapshot, index) {
            ...
            return Padding(
              ...
              child: Container(
                ...
                child: ListTile(
                  onTap: () {
                    earnings.text = recipe.earnings.toString();
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: "Earnings in Rupees",
                                          label:
                                              const Text("Earnings in Rupees"),
                                          filled: true,
                                          border: OutlineInputBorder(
                                            borderRadius:
                                                BorderRadius.circular(10.0),
                              ...
                              onPressed: () async {
                                if (form.currentState!.validate()) {
                                  ...
                                  recipeServices.updateEarnings(
                                      id: recipe.rid!,
                                      earnings: int.parse(earnings.text));
                                  Navigator.pop(context);
                                  price.clear();
